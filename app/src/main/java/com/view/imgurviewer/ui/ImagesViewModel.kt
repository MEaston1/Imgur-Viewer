...
class ImagesViewModel(val imageRepository: ImagesRepo) :ViewModel(){
    val popularImages: MutableLiveData<Resource<ImgurResponse>> = MutableLiveData()     // used for fragments to subscribe to the live data to automatically update them
